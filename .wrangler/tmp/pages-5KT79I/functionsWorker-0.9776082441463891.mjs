...
var json = /* @__PURE__ */ __name((data, status = 200) => Response.json(data, { status, headers: { "Access-Control-Allow-Origin": "*" } }), "json");
...
// ../.wrangler/tmp/pages-5KT79I/functionsRoutes-0.2648845586747208.mjs
var routes = [
  {
    routePath: "/api/logs",
    mountPath: "/api",
...
// C:/Users/powar/AppData/Roaming/npm/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/powar/AppData/Roaming/npm/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-Ztuhvu/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Ztuhvu/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9776082441463891.mjs.map
